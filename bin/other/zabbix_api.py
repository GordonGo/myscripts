...
class zabbix_api: 
	def __init__(self): 
	    self.url = 'http://123.59.15.228/zabbix/api_jsonrpc.php' #修改URL
...
if __name__ == "__main__":
	...
	parser.add_argument('-C','--add-host',dest='addhost',nargs=4,metavar=('host_ip', 'host_name','group1,group2...', 'Template1,Template2...'),help='添加主机,多个主机组或模板使用分号')
